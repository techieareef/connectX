...
class BuyerSellers extends StatelessWidget {
  ProductItemClass _item;
  BuyerSellers(this._item);
  @override
...
class TopBuyerSeller extends StatefulWidget {
  @override
  _TopBuyerSellerState createState() => _TopBuyerSellerState();
}
class _TopBuyerSellerState extends State<TopBuyerSeller> {
...
//                  Navigator.push(context, MaterialPageRoute(builder: (contetx)=> DetailPage()));
                ...
                child: Row(
                  children: <Widget>[
                    BuyerSellers(productData[index]),
                    SizedBox(width: 24,)
                  ],
                ),
              )
