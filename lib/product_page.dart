import 'package:connectx/show_more.dart';
...
class _ProductsMenuState extends State<ProductsMenu> {
  ...
  void initState() {
    ...
    super.initState();
    productData.add(new ProductItemClass(false,secondColor, "assets/products/hanginglight.png", "Madhapur Metro Station", "Hyderabad Mango seeds conf", "Elegant"));
    productData.add(new ProductItemClass(false,secondColor, "assets/products/desklamp.png", "Madhapur Metro Station", "Hyderabad Mango seeds conf", "Classic"));
  }
  @override
  Widget build(BuildContext context) {
    return Container(
